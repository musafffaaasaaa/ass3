...
import (
	...
	"musa.net/internal/jsonlog"
	"musa.net/internal/mailer"
	"net/http"
	"os"
	"sync"
	"time"
...
func main() {
	...
	flag.IntVar(&cfg.smtp.port, "smtp-port", 600, "SMTP port")
	flag.StringVar(&cfg.smtp.username, "smtp-username", "211669@astanait.edu.kz", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "AITU2021!", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "211669@astanait.edu.kz", "SMTP sender")
...
// go run ./cmd/api -smtp-host="smtp.office365.com" -smtp-username="211669@astanait.edu.kz" -smtp-password="AITU2021!" -smtp-sender="" -smtp-port=600
